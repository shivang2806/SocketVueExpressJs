      ...
      <div class="row mt-5">
        <div class="col-md-4"></div>
          ...
          <div class="col-md-4">
            <div class="login-box">
              <div class="p-5">
                <h1 class="title" style="margin: 5px 190px;">Signup</h1>
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Password" v-model="form_data.confirm_password">
                  </div>
                  <button type="button" class="btn btn-primary mt-3" @click="createUser" >Sign Up</button>
                </form>
              </div>
            </div>
          </div>
